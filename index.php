        ...
        <div class="col-sm-9 mx-auto">
            ...
            <div class="row mb-3 align-items-end">
                ...
                <div class="col-md-3 text-end">
                    <a href="/todolist/tarefas/cadastro_tarefa.php" class="btn btn-primary w-100">
                ...
                <tbody id="tabelaTarefas">
                    <?php foreach ($tarefas as $tarefasad): ?>                        
                        <tr class="<?= $tarefasad['status'] == 1 ? 'table-success' : '' ?>" 
                            ...
                            <td>                                
                                <a href="/todolist/tarefas/visualizar_tarefas?id=<?= $tarefasad['id'] ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>                                
...
<script>
    function abrirModal(id) {        
        document.getElementById('confirmButton').href = '/todolist/tarefas/concluir_tarefa.php?id=' + id;        
    ...
    function abrirDeleteModal(id) {
        ...
        document.getElementById('confirmDeleteButton').href = '/todolist/tarefas/excluir_tarefa.php?id=' + id;        
